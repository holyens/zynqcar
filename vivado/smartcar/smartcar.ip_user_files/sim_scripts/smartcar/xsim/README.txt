...
#
# Generated by export_simulation on Tue Apr 04 19:52:09 +0800 2017
#
################################################################################
...
switch to the './smartcar.sh' script.

./smartcar.sh -reset_run
...
./smartcar.sh -noclean_files

For more information on the script, please type './smartcar.sh -help'.
