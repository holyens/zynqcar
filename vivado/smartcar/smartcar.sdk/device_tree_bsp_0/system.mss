...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = mygpio_ip_0
 PARAMETER compatible = xlnx,mygpio-ip-1.0
...
BEGIN DRIVER
 ...
 PARAMETER compatible = xlnx,speedsensor-ip-1.0
...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = generic
 PARAMETER HW_INSTANCE = sr04_ip_0
 PARAMETER compatible = xlnx,sr04-ip-2.0
