...
################################################################
# This is a generated script based on design: smartcar
#
...
proc create_root_design { parentCell } {
  ...
  set optical [ create_bd_port -dir I -from 4 -to 0 optical ]
  set pwm_ctr1 [ create_bd_port -dir O pwm_ctr1 ]
  set pwm_ctr2 [ create_bd_port -dir O pwm_ctr2 ]
  set pwm_out1 [ create_bd_port -dir O pwm_out1 ]
  set pwm_out2 [ create_bd_port -dir O pwm_out2 ]
  set speed_in1 [ create_bd_port -dir I -from 1 -to 0 speed_in1 ]
  set speed_in2 [ create_bd_port -dir I -from 1 -to 0 speed_in2 ]
  set sr04_echo [ create_bd_port -dir I -from 2 -to 0 sr04_echo ]
  set sr04_trig [ create_bd_port -dir O sr04_trig ]
...
CONFIG.NUM_MI {4} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins mygpio_ip_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins pwm_ip_0/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins ps7_0_axi_periph/M02_AXI] [get_bd_intf_pins speedsensor_ip_0/S00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M03_AXI [get_bd_intf_pins ps7_0_axi_periph/M03_AXI] [get_bd_intf_pins sr04_ip_0/S00_AXI]

  # Create port connections
  connect_bd_net -net UART0_RX_1 [get_bd_ports UART0_RX] [get_bd_pins processing_system7_0/UART0_RX]
  connect_bd_net -net mygpio_ip_0_led [get_bd_ports led] [get_bd_pins mygpio_ip_0/led]
  connect_bd_net -net optical_1 [get_bd_ports optical] [get_bd_pins mygpio_ip_0/optical]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins mygpio_ip_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/M03_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins pwm_ip_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk] [get_bd_pins speedsensor_ip_0/s00_axi_aclk] [get_bd_pins sr04_ip_0/s00_axi_aclk]
  ...
  connect_bd_net -net pwm_ip_0_pwm_ctr1 [get_bd_ports pwm_ctr1] [get_bd_pins pwm_ip_0/pwm_ctr1]
  connect_bd_net -net pwm_ip_0_pwm_ctr2 [get_bd_ports pwm_ctr2] [get_bd_pins pwm_ip_0/pwm_ctr2]
  connect_bd_net -net pwm_ip_0_pwm_out1 [get_bd_ports pwm_out1] [get_bd_pins pwm_ip_0/pwm_out1]
  connect_bd_net -net pwm_ip_0_pwm_out2 [get_bd_ports pwm_out2] [get_bd_pins pwm_ip_0/pwm_out2]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins mygpio_ip_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/M03_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins pwm_ip_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn] [get_bd_pins speedsensor_ip_0/s00_axi_aresetn] [get_bd_pins sr04_ip_0/s00_axi_aresetn]
  connect_bd_net -net speed_in1_1 [get_bd_ports speed_in1] [get_bd_pins speedsensor_ip_0/speed_in1]
  connect_bd_net -net speed_in2_1 [get_bd_ports speed_in2] [get_bd_pins speedsensor_ip_0/speed_in2]
  connect_bd_net -net sr04_echo_1 [get_bd_ports sr04_echo] [get_bd_pins sr04_ip_0/sr04_echo]
  connect_bd_net -net sr04_ip_0_sr04_trig [get_bd_ports sr04_trig] [get_bd_pins sr04_ip_0/sr04_trig]
  connect_bd_net -net sw_1 [get_bd_ports sw] [get_bd_pins mygpio_ip_0/sw]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs mygpio_ip_0/S00_AXI/S00_AXI_reg] SEG_mygpio_ip_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C10000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs pwm_ip_0/S00_AXI/S00_AXI_reg] SEG_pwm_ip_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C20000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs speedsensor_ip_0/S00_AXI/S00_AXI_reg] SEG_speedsensor_ip_0_S00_AXI_reg
  create_bd_addr_seg -range 0x00010000 -offset 0x43C30000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs sr04_ip_0/S00_AXI/S00_AXI_reg] SEG_sr04_ip_0_S00_AXI_reg
...
preplace port UART0_TX -pg 1 -y 500 -defaultsOSRD
preplace port sr04_trig -pg 1 -y 580 -defaultsOSRD
preplace port UART0_RX -pg 1 -y 400 -defaultsOSRD
preplace port pwm_out1 -pg 1 -y 200 -defaultsOSRD
preplace port pwm_out2 -pg 1 -y 220 -defaultsOSRD
preplace port pwm_ctr1 -pg 1 -y 240 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 480 -defaultsOSRD
preplace port pwm_ctr2 -pg 1 -y 260 -defaultsOSRD
preplace portBus sw -pg 1 -y 20 -defaultsOSRD
preplace portBus speed_in1 -pg 1 -y 60 -defaultsOSRD
preplace portBus speed_in2 -pg 1 -y 420 -defaultsOSRD
preplace portBus sr04_echo -pg 1 -y 740 -defaultsOSRD
preplace portBus led -pg 1 -y 80 -defaultsOSRD
preplace portBus optical -pg 1 -y 40 -defaultsOSRD
preplace inst speedsensor_ip_0 -pg 1 -lvl 3 -y 380 -defaultsOSRD
preplace inst pwm_ip_0 -pg 1 -lvl 3 -y 230 -defaultsOSRD
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 260 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 1 -y 300 -defaultsOSRD
preplace inst mygpio_ip_0 -pg 1 -lvl 3 -y 80 -defaultsOSRD
preplace inst sr04_ip_0 -pg 1 -lvl 3 -y 580 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 580 -defaultsOSRD
preplace netloc ps7_0_axi_periph_M02_AXI 1 2 1 710
preplace netloc processing_system7_0_DDR 1 1 3 NJ 470 NJ 470 970J
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 410
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 430 80 700
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 30 210 390
preplace netloc ps7_0_axi_periph_M03_AXI 1 2 1 690
preplace netloc pwm_ip_0_pwm_out1 1 3 1 NJ
preplace netloc ps7_0_axi_periph_M01_AXI 1 2 1 690
preplace netloc processing_system7_0_UART0_TX 1 1 3 450J 500 NJ 500 NJ
preplace netloc pwm_ip_0_pwm_out2 1 3 1 NJ
preplace netloc mygpio_ip_0_led 1 3 1 NJ
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 490 NJ 490 970J
preplace netloc optical_1 1 0 3 NJ 40 NJ 40 710J
preplace netloc pwm_ip_0_pwm_ctr1 1 3 1 NJ
preplace netloc sw_1 1 0 3 NJ 20 NJ 20 740J
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 190 440 670 740
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 720
preplace netloc speed_in1_1 1 0 3 NJ 60 NJ 60 730J
preplace netloc UART0_RX_1 1 0 2 NJ 400 380
preplace netloc sr04_echo_1 1 0 3 NJ 740 NJ 740 750J
preplace netloc pwm_ip_0_pwm_ctr2 1 3 1 NJ
preplace netloc speed_in2_1 1 0 3 NJ 420 400J 440 750J
preplace netloc sr04_ip_0_sr04_trig 1 3 1 NJ
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 1 420
levelinfo -pg 1 0 210 570 860 990 -top 0 -bot 760
",
}
